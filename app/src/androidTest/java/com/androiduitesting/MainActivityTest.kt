...
class MainActivityTest{
    ...
    fun test_isActivityInView() {
        ...
        //launches a new activity in order to run checks
    ...
    fun test_backPress_toMainActivity() {
        ...
        //onView(withId(R.id.button_back)).perform(click()) //method 1 for back navigation
        pressBack() //method 2 for back navigation
        onView(withId(R.id.main)).check(matches(isDisplayed()))
    }
}